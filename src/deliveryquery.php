...
<html lang="en">
  <head>
    ...
    <title>SES Email Delivery Query</title>
...
?>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">Delivered Email Query Tool</h3>
		</div>
		<form method='post' action=''>
			<div class='panel-body'>
				This tool allows you to query for delivered emails.  Wildcards in the form of an asterix are permitted.  You MUST specify a date filter (minium is 1 day).
...
$deliveryTable = $appConfig['dynamodb']['deliverytable'];
	...
	if (empty($infoText))
	{
		if ( isset($_POST["search-email"]) )
		{
			...
			if (!empty($_POST['recipient_email']))
			{
				...
				$panelTitle = "Delivered emails for recipient: " . $recipientAddressToQuery;

				$resultDataSet = deliverySearch($dynamoClient,$deliveryTable,$recipientAddressToQuery,$startDate,$endDate);
